...
public class QHSample_Frame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		String filePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/quadrah/designeditor/frame";
        ...
        mSpenSurfaceView.setToolTypeAction(SpenSurfaceView.ACTION_NONE, SpenSurfaceView.ACTION_NONE);
    }
